...
export const metadata: Metadata = {
  ...
  alternates: { canonical: url("/descargar-modelos-stl") },
};
...
export default function DescargarModelos() {
  return (
    <main id="contenido" className="relative">
      ...
      <div className="contenido relative py-16">
        <JsonLd
          datos={schemaMigas([
            { nombre: "Descargar modelos STL", href: "/descargar-modelos-stl" },
          ])}
        />
        ...
        >
          ...
          <p className="medida mt-4 text-texto-secundario">
            Si ya bajaste el archivo y no tienes impresora —o no quieres pelearte
            con el rebanado, el relleno y los soportes—, eso es justo lo que
            hago: imprimir lo que otros diseñaron.
          </p>
          ...
          <ul className="mt-3 space-y-2 text-texto-secundario">
            ...
            <li>
              <Link
                ...
                className="text-arcilla-oscura underline underline-offset-4 hover:text-grafito"
              >
                Catálogo de modelos del taller
              </Link>{" "}
              — diseños propios: el diseño no se cobra, solo la impresión.
            </li>
          </ul>
        </aside>
      </div>
