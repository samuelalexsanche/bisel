        ...
        <div>
          ...
          <div className="medida mt-8 space-y-5 text-cuerpo">
            <p className="text-grafito">
              Me llamo {BRAND.founder}. Imprimo desde {BRAND.city} y contesto yo
              los mensajes.
            </p>
            ...
            <p className="text-texto-secundario">
              No hay un equipo de atención ni un conmutador. Cuando escribes por
              WhatsApp te contesto yo, y si no puedo hacer tu pieza te lo digo
      ...
      <Reveal>
        <section className="bajo-fold mt-16 max-w-3xl">
          ...
          <p className="medida mt-4 text-texto-secundario">
            ...
            gente que no existe. El taller abrió hace poco. Las reseñas se van a
            publicar desde la primera venta, con nombre de quien las escribió.
          </p>
          <p className="medida mt-4 text-texto-secundario">
